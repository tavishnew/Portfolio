...
export function AboutIntro() {
  return (
    <p>
      I&apos;m <InteractiveName />, a 22-year-old software developer from India
      passionate about full-stack development, AI, and building modern, scalable
      applications. I enjoy solving real-world problems through clean code,
      thoughtful design, and creating products that are fast, intuitive, and
      easy to use.
    </p>
  )
}
