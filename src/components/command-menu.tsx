...
const OTHER_LINK_ITEMS: CommandLinkItem[] = [
  {
    title: "Music",
    href: "https://open.spotify.com/blend/taste-match/3e0317fa820bf153?si=FnImOg-vQKWsbQ7y00hthA&fallback=getapp&blendDecoration=5f9c38d2",
    kind: "link",
    icon: <Music2Icon />,
  ...
  {
    title: "Instagram",
    href: "https://www.instagram.com/invites/contact/?utm_source=ig_contact_invite&utm_medium=copy_link&utm_content=kx3b109",
    kind: "link",
    icon: <CameraIcon />,
...
const FOOTER_WRAPPER =
  "absolute inset-x-0 bottom-0 flex h-10 items-center justify-between gap-2 rounded-b-2xl px-4 text-xs font-medium"
  ...
  return (
    <CommandGroup heading="Brand Assets" data-testid="command-brand-assets">
      <CommandMenuItem
        ...
        onSelect={() => onCopy(getMarkSVG(), "Mark as SVG copied")}
      >
        <ChanhDaiMark />
        Copy Mark as SVG
      </CommandMenuItem>
      ...
      <CommandMenuItem
        onHighlight={onHighlight}
        onSelect={() => onCopy(getWordmarkSVG(), "Logotype as SVG copied")}
      >
        <TypeIcon />
