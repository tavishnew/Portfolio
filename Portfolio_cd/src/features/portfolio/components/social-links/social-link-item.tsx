...
export function SocialLinkItem({ icon, title, href, ariaLabel, target, rel }: SocialLink) {
  ...
  const linkTarget = target ?? (isEmailLink || isWhatsAppLink ? undefined : "_blank")
  const linkRel = rel ?? (isEmailLink || isWhatsAppLink ? undefined : "noopener noreferrer")
